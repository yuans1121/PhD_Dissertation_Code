...
load 2018-04-07_leaky_E_4_V_PH_X_2
...
PhaseCorrMask=PhaseCorr.*MaskX;

F3=figure('units','normalized','outerposition',[0 0 1 1]);
% suptitle('NEAR-FIELD (METHOD 1)')
Fig1=subplot(1,2,1);
imagesc(x,y,ModulTau)
% imagesc(x,y(1:N/2),ModulTau(1:N/2,:))
% imagesc(x,y,rot90(ModulTau,3))
title('|E|')
...
Fig2=subplot(1,2,2);
imagesc(x,y,PhaseCorrMask)
% imagesc(x,y(1:N/2),PhaseTauMask(1:N/2,:))
% imagesc(x,y,rot90(PhaseTauMask,3))
title('E Phase')
...
F5=figure();
for jj=1:Nframes
    PhaseEvol=PhaseCorr+ones(N).*PhaseSpace(jj);
...
% v=VideoWriter(strcat(dir,'\','5.phase_evol.avi'));
% v.FrameRate=10;
% open(v);
